...
Base.extend = function (a, b) {
    ...
    a.toolbar.Toolbar = Base.extend({constructor: function (b, c) {
        ...
        for (var a = this, c = this.editor, d = this.container, e = this.commandLinks.concat(this.actionLinks), f = e.length, g = 0; f > g; g++)b.setAttributes({href: "javascript:;", unselectable: "on"}).on(e[g]);
